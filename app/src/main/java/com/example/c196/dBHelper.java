...
public class dBHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME4 = "Loan_Table";
    ...
    //CurrentPossessions
    public static final String LoanedOutItem = "LoanedOutItem";
    public static final String LoanedOutTo = "LoanedOutTo";
    public static final String LoanedOutOnDate = "LoanedOutOnDate";
